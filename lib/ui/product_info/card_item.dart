      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                Image.asset('assets/images/anpr.png', width: 100, height: 20,),
                Spacer(),
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Center(
                      child: Center(
                        child: Text("Rasmiylashtirish", style: TextStyle(
                          fontSize: 14,
                          color: Colors.white
                        ),),
                      ),
  ...
  return Padding(
    ...
    child: Container(
      ...
      child:  Padding(
        ...
        child: Row(
          children: [
            Image.asset('assets/images/img_8.png', width: 100, height: 56,),
            Spacer(),
            Text("oyiga ", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16.0),),
            Text(price, style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16.0),),
            Text(" som", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16.0),)
