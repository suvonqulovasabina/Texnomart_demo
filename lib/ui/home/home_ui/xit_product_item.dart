 ...
 // bool isFavorite = favoriteRepo.isFavorite(id);
  ...
  void checkingFav() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
            data.isCheck ? 'Mahsulot sevimlilarda' : 'Mahsulot olib tashlandi'),
              ...
              child: Stack(
                children: [
                  ...
                  const Positioned(
                      top: 67,
                      right: 8,
                      child: Icon(Icons.balance,color: Colors.grey,)),

                  Positioned( bottom: 165, child: readItem()),
