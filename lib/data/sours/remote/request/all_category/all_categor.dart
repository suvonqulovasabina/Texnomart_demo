...
part 'all_categor.g.dart';

part 'all_categor.freezed.dart';


@freezed
class AllCategor with _$AllCategor {
  @JsonSerializable(explicitToJson: true, fieldRename: FieldRename.snake)
  const factory AllCategor(
      bool? success,
      String? message,
      int? code,
  ...
  factory AllCategor.fromJson(Map<String, dynamic> json) =>
      _$AllCategorFromJson(json);
}
