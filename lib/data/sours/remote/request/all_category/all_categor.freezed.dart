...
AllCategor _$AllCategorFromJson(Map<String, dynamic> json) {
  return _AllCategor.fromJson(json);
}
...
mixin _$AllCategor {
  ...
  @JsonKey(ignore: true)
  $AllCategorCopyWith<AllCategor> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AllCategorCopyWith<$Res> {
  factory $AllCategorCopyWith(
          AllCategor value, $Res Function(AllCategor) then) =
      _$AllCategorCopyWithImpl<$Res, AllCategor>;
  @useResult
  $Res call(
      {bool? success,
      String? message,
...
/// @nodoc
class _$AllCategorCopyWithImpl<$Res, $Val extends AllCategor>
    implements $AllCategorCopyWith<$Res> {
  _$AllCategorCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$AllCategorImplCopyWith<$Res>
    implements $AllCategorCopyWith<$Res> {
  factory _$$AllCategorImplCopyWith(
          _$AllCategorImpl value, $Res Function(_$AllCategorImpl) then) =
      __$$AllCategorImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {bool? success,
...
/// @nodoc
class __$$AllCategorImplCopyWithImpl<$Res>
    extends _$AllCategorCopyWithImpl<$Res, _$AllCategorImpl>
    implements _$$AllCategorImplCopyWith<$Res> {
  __$$AllCategorImplCopyWithImpl(
      _$AllCategorImpl _value, $Res Function(_$AllCategorImpl) _then)
      : super(_value, _then);
...
class _$AllCategorImpl implements _AllCategor {
  const _$AllCategorImpl(this.success, this.message, this.code, this.data);

  factory _$AllCategorImpl.fromJson(Map<String, dynamic> json) =>
      _$$AllCategorImplFromJson(json);
  ...
  @override
  String toString() {
    return 'AllCategor(success: $success, message: $message, code: $code, data: $data)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$AllCategorImplCopyWith<_$AllCategorImpl> get copyWith =>
      __$$AllCategorImplCopyWithImpl<_$AllCategorImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$AllCategorImplToJson(
      this,
    );
  }
}

abstract class _AllCategor implements AllCategor {
  const factory _AllCategor(
      final bool? success,
      final String? message,
      final int? code,
      final GetProductAllCategoryData? data) = _$AllCategorImpl;

  factory _AllCategor.fromJson(Map<String, dynamic> json) =
      _$AllCategorImpl.fromJson;
